							...
							<div class="col-12">
								<div class="card">
                                    ...
                                    <form action="proses/proses-prodi.php?aksi=updateprodi" method="POST">
									    <div class="card-body">
                                            <div class="mb-3">
                                                <label for="nama" class="form-label">id Program</label>
                                                <input type="text" class="form-control-plaintext" id="kode" name="kode" placeholder="Masukkan Kode Program Studi" value="<?php echo $dataproduk['id']; ?>" required readonly>
                                            </div>
											<div class="mb-3">
												<label for="nama" class="form-label">Nama produk</label>
												<input type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan Nama Program Studi" value="<?php echo $dataproduk['nama']; ?>" required>
											</div>
                                        </div>
